...
# -*- coding: utf-8 -*-
#
# ktcal2 documentation build configuration file, created by
# sphinx-quickstart on Wed Jul 30 11:42:24 2014.
#
...
latex_documents = [
  ('index', 'ktcal2.tex', 'ktcal2 Documentation',
   'cr0hn', 'manual'),
]
...
man_pages = [
    ('index', 'ktcal2', 'ktcal2 Documentation',
     ['cr0hn'], 1)
]
...
texinfo_documents = [
  ('index', 'ktcal2', 'ktcal2 Documentation',
   'cr0hn', 'ktcal2', 'One line description of project.',
   'Miscellaneous'),
]
